...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('nozzlle_transaction', '0005_nozzlle_t_total_amount'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='nozzlle_t',
            name='closing_time',
            field=models.TimeField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0, 'Value should not be less than 0')]),
        ),
        migrations.AlterField(
            model_name='nozzlle_t',
        ...
        migrations.AlterField(
            ...
            field=models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0, 'Value should not be less than 0')]),
        ),
        migrations.AlterField(
            model_name='nozzlle_t',
            name='googlePay',
